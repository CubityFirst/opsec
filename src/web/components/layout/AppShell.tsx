import { BellIcon, CalendarRangeIcon, LayoutDashboardIcon, LogOutIcon, MapIcon, MenuIcon, SearchIcon, SparklesIcon, TagIcon, UserIcon, UsersIcon } from "lucide-react";
...
const NAV = [
  ...
  { to: "/timeline", label: "Timeline", icon: CalendarRangeIcon },
