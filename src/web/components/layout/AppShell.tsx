import { DicesIcon, LayoutDashboardIcon, LogOutIcon, MenuIcon, SearchIcon, SparklesIcon, TagIcon, UserIcon, UsersIcon } from "lucide-react";
...
const NAV = [
  ...
  { to: "/bets", label: "Bets", icon: DicesIcon },
