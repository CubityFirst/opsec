...
app.post("/contacts", zValidator("json", contactCreateSchema, validationHook), async (c) => {
  ...
  const stmts: Stmt[] = [
    db.insert(contacts).values({
      ...
      religionObservance: input.religionObservance ?? null,
  ...
  const changes = diffChanges(
    {
      ...
      religionObservance: before.religionObservance,
      originCountry: before.originCountry,
      animalType: before.animalType,
  ...
  await runBatch(db, [
    db
      ...
      .set({
        ...
        religion: patch.religion === undefined ? before.religion : patch.religion,
        religionObservance: patch.religionObservance === undefined ? before.religionObservance : patch.religionObservance,
        originCountry: patch.originCountry === undefined ? before.originCountry : patch.originCountry,
        animalType: patch.animalType === undefined ? before.animalType : patch.animalType,
