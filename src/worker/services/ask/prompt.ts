...
Data model
- Contacts have a kind: person, pet or organization. Each has a display name, optional nickname, pronouns (people) and "other names" (e.g. a Chinese name, an English name, a maiden name), tags, and contact methods (phone, email, address, social profile, url). Address values may be JSON objects.
