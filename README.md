...
- **Names as people use them.** Nickname, pronouns and any number of other names (a Chinese name, a maiden name), all searchable. People can carry a religion, written the way they would put it themselves (the picker suggests the common ones but keeps whatever you type). Pets carry an animal type (species or breed).
